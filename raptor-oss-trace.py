...
if __name__ == "__main__":
    ...
    # サマリー用のプロンプトに日本語回答をさせる
    from llama_index.packs.raptor.base import SummaryModule

    summary_prompt = "Summarize the provided text in Japanese, including as many key details as needed."
    summary_module = SummaryModule(llm=llm, summary_prompt=summary_prompt)
    ...
    raptor_pack = RaptorPack(
        ...
        summary_module=summary_module,  # サマリ生成用プロンプト改変したモジュール
        transformations=[
